...
public class UI implements ActionListener {
   ...
   public UI() throws IOException {
      frame = new JFrame("Calculator by Josh C-Reid");
   ...
   public void init() {      
      ...
      butAdd.setBackground(Color.LIGHT_GRAY);
      butMinus.setBackground(Color.LIGHT_GRAY);
      butMultiply.setBackground(Color.LIGHT_GRAY);
      butDivide.setBackground(Color.LIGHT_GRAY);
      butEqual.setBackground(Color.LIGHT_GRAY);
      butSquareRoot.setBackground(Color.LIGHT_GRAY);
      butSquare.setBackground(Color.LIGHT_GRAY);
      butOneDividedBy.setBackground(Color.LIGHT_GRAY);
      butCos.setBackground(Color.LIGHT_GRAY);
      butSin.setBackground(Color.LIGHT_GRAY);
      butTan.setBackground(Color.LIGHT_GRAY);
      butxpowerofy.setBackground(Color.LIGHT_GRAY);
      butlog.setBackground(Color.LIGHT_GRAY);
      butrate.setBackground(Color.LIGHT_GRAY);
      butabs.setBackground(Color.LIGHT_GRAY);
      butCancel.setBackground(Color.LIGHT_GRAY);
      butBinary.setBackground(Color.LIGHT_GRAY); 
